...
public class AssistantApplication {
    ...
    @Bean
    PromptChatMemoryAdvisor promptChatMemoryAdvisor(DataSource memory) {
...
class AssistantController {
    ...
    AssistantController(
        ...
        var system = """
                ...
                named Pooch Palace with locations in Antwerp, Seoul, Tokyo, Singapore, Paris, Mumbai, 
                New Delhi, Barcelona, San Francisco, and London. Information about the dogs availables 
                will be presented below. If there is no information, then return a polite response suggesting 
                wes don't have any dogs available.
